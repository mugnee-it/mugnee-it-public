...
const PAGE_PATH = "/services/shopify/shopify-seo-service";
const PAGE_URL = `${SITE_URL}${PAGE_PATH}`;
const KEYWORD = "Shopify SEO Service";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: `${KEYWORD}`,
  description:
    "Shopify SEO service with on-page setup, collection structure, metadata, and indexing readiness.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: KEYWORD,
    description: "SEO-ready Shopify setup with clean structure and metadata guidance.",
    url: PAGE_URL,
    ...
    <main className="bg-white">
      <section className="mx-auto max-w-6xl px-4 pt-16 pb-16">
        <nav className="text-xs font-bold text-slate-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-900">SEO Service</span>
        </nav>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              We set up Shopify SEO basics with clean URL structure, metadata guidance, image
              optimization, and indexing readiness.
            </p>

            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <Bullet text={`${KEYWORD} structure review`} />
              <Bullet text={`${KEYWORD} metadata setup`} />
              <Bullet text={`${KEYWORD} image optimization`} />
              <Bullet text={`${KEYWORD} indexing readiness`} />
            </div>
          ...
          <div className="rounded-3xl border bg-slate-50 p-6">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700">
              <Mini text={`${KEYWORD} clean structure`} />
              <Mini text={`${KEYWORD} better indexing`} />
              <Mini text={`${KEYWORD} metadata guidance`} />
              <Mini text={`${KEYWORD} SEO checklist`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <Section
        ...
        items={[
          "Review collections and URL structure",
          "Set metadata and SEO-friendly templates",
          "Optimize images and alt text",
          "Prepare indexing readiness checklist",
        ]}
      />
      ...
      <Section
        ...
        items={[
          ...
          "Metadata and on-page setup",
          "Image optimization checklist",
          "SEO guidance for products",
        ]}
      />
      ...
      <Faq
        title={`${KEYWORD} FAQ`}
        items={[
          ["Do you guarantee rankings?", "No, SEO depends on competition and ongoing content."],
          ["Do you optimize product pages?", "We set structure and metadata guidance for products."],
          ["Do you handle keywords?", "We can advise on priority keywords based on your niche."],
          ["Is this only for new stores?", "It works for both new and existing stores."],
        ]}
      />
    </main>
  );
