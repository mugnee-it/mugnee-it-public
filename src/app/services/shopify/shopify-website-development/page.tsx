...
const PAGE_PATH = "/services/shopify/shopify-website-development";
const PAGE_URL = `${SITE_URL}${PAGE_PATH}`;
const KEYWORD = "Shopify Website Development";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: `${KEYWORD}`,
  description:
    "Shopify website development with conversion-first layout, product structure, checkout setup, and performance-ready build.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: KEYWORD,
    description: "Build a Shopify website with clean UI, fast load, and scalable structure.",
    url: PAGE_URL,
    ...
    <main className="bg-white">
      <section className="mx-auto max-w-6xl px-4 pt-16 pb-16">
        <nav className="text-xs font-bold text-slate-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-900">Website Development</span>
        </nav>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border bg-white px-4 py-2 text-xs font-extrabold text-slate-700">
              <LayoutTemplate className="h-4 w-4 text-indigo-700" />
              BUILD
            </div>
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              We build Shopify websites with clean structure, conversion-first layout, and fast
              performance so your store looks premium and sells more.
            </p>

            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <Bullet text={`${KEYWORD} planning`} />
              <Bullet text={`${KEYWORD} UI structure`} />
              <Bullet text={`${KEYWORD} product setup`} />
              <Bullet text={`${KEYWORD} checkout readiness`} />
            </div>
          ...
          <div className="rounded-3xl border bg-slate-50 p-6">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700">
              <Mini text={`${KEYWORD} conversion-first layout`} />
              <Mini text={`${KEYWORD} clean navigation`} />
              <Mini text={`${KEYWORD} fast store setup`} />
              <Mini text={`${KEYWORD} scalable structure`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <Section
        ...
        items={[
          "Collect brand assets and product list",
          "Plan structure: pages, collections, navigation",
          "Build theme sections and product layouts",
          "QA for checkout, speed, and SEO basics",
        ]}
      />
      ...
      <Section
        ...
        items={[
          "Store structure + page layout setup",
          "Product and collection organization",
          "Checkout, shipping, and payment setup",
          "Launch checklist and handover notes",
        ]}
      />
      ...
      <Section
        ...
        items={[
          "Clear build milestones",
          "Feedback revisions on layout",
          "Post-launch support guidance",
          "Performance and SEO basics review",
        ]}
      />
      ...
      <Faq
        title={`${KEYWORD} FAQ`}
        items={[
          ["Do you build custom Shopify websites?", "Yes, we build from scratch with a clean layout and store structure."],
          ["Will the store be fast?", "Yes, we use lightweight design and optimize for performance."],
          ["Can you add products and collections?", "Yes, we structure products and collections properly."],
          ["Do you support after launch?", "Yes, we provide after-sale support and quick fixes."],
        ]}
      />
    </main>
  );
