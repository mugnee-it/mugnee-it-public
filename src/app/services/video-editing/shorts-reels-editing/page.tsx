...
const PAGE_PATH = "/services/video-editing/shorts-reels-editing";
const PAGE_URL = `${SITE_URL}${PAGE_PATH}`;
const KEYWORD = "Shorts & Reels Editing Service";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: `${KEYWORD}`,
  description:
    "Shorts & Reels editing service with hook-first pacing, captions, and platform-ready exports.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: KEYWORD,
    description: "Shortâ€‘form edits with captions, pacing, and clean delivery.",
    url: PAGE_URL,
...
export default function ShortsReelsEditingPage() {
  return (
    <main className="bg-white">
      <section className="mx-auto max-w-6xl px-4 pt-16 pb-16">
        <nav className="text-xs font-bold text-slate-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-900">Shorts & Reels</span>
        </nav>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              Hookâ€‘first shortâ€‘form edits with captions, pacing, and clean exports for social platforms.
            </p>

            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <Bullet text={`${KEYWORD} hook pacing`} />
              <Bullet text={`${KEYWORD} captions`} />
              <Bullet text={`${KEYWORD} safe margins`} />
              <Bullet text={`${KEYWORD} export-ready`} />
            </div>
          ...
          <div className="rounded-3xl border bg-slate-50 p-6">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700">
              <Mini text={`${KEYWORD} higher retention`} />
              <Mini text={`${KEYWORD} clean captions`} />
      ...
      <Faq
        title={`${KEYWORD} FAQ`}
        items={[
          ["Do you add captions?", "Yes, clean captions are included."],
          ["Do you optimize for retention?", "Yes, hook-first pacing."],
          ["Do you deliver in 9:16?", "Yes, vertical exports are supported."],
          ["Can you edit in batches?", "Yes, batch workflows are available."],
        ]}
      />
    </main>
  );
