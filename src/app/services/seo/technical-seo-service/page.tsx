...
const PAGE_PATH = "/services/seo/technical-seo-service";
const PAGE_URL = `${SITE_URL}${PAGE_PATH}`;
const KEYWORD = "Technical SEO Service";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: `${KEYWORD}`,
  description:
    "Technical SEO service for indexing fixes, crawl structure, canonical, sitemap, and performance basics.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: KEYWORD,
    description: "Fix technical SEO issues and improve crawl and indexing health.",
    url: PAGE_URL,
    ...
    <main className="bg-white">
      <section className="mx-auto max-w-6xl px-4 pt-16 pb-16">
        <nav className="text-xs font-bold text-slate-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-900">Technical SEO</span>
        </nav>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              We fix technical SEO issues that block rankings: crawl paths, indexing, canonicals,
              sitemaps, redirects, and performance basics.
            </p>

            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <Bullet text={`${KEYWORD} crawl cleanup`} />
              <Bullet text={`${KEYWORD} indexing fixes`} />
              <Bullet text={`${KEYWORD} canonical setup`} />
              <Bullet text={`${KEYWORD} sitemap review`} />
            </div>
          ...
          <div className="rounded-3xl border bg-slate-50 p-6">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700">
              <Mini text={`${KEYWORD} clean crawl path`} />
              <Mini text={`${KEYWORD} stable indexing`} />
              <Mini text={`${KEYWORD} stronger site structure`} />
              <Mini text={`${KEYWORD} better SEO foundation`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <Section
        ...
        items={[
          "Audit crawl and index coverage",
          "Fix sitemap, canonicals, and redirects",
          "Improve internal linking paths",
          "Check CWV and performance basics",
        ]}
      />
      ...
      <Section
        ...
        items={[
          ...
          "Canonical and redirect updates",
      ...
      <Faq
        title={`${KEYWORD} FAQ`}
        items={[
          ["Do you fix indexing issues?", "Yes, we handle coverage, sitemaps, and canonicals."],
          ["Is this for new sites only?", "No, we improve both new and existing sites."],
          ["Will this improve rankings?", "It improves the foundation for rankings."],
          ["Do you handle redirects?", "Yes, we fix redirect chains and errors."],
        ]}
      />
    </main>
  );
