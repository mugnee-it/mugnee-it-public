...
const PAGE_PATH = "/services/seo/seo-audit-service";
const PAGE_URL = `${SITE_URL}${PAGE_PATH}`;
const KEYWORD = "SEO Audit Service";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: `${KEYWORD}`,
  description:
    "SEO audit service with technical review, content gaps, internal linking analysis, and priority roadmap.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: KEYWORD,
    description: "Detailed SEO audit with issues list and action plan.",
    url: PAGE_URL,
  ...
  return (
    <main className="bg-white">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              We audit your website for technical issues, content gaps, internal linking, and
              on-page weaknesses, then provide a prioritized action roadmap.
            </p>

            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <Bullet text={`${KEYWORD} technical review`} />
              <Bullet text={`${KEYWORD} content gaps`} />
              <Bullet text={`${KEYWORD} internal linking`} />
              <Bullet text={`${KEYWORD} action roadmap`} />
            </div>
          ...
          <div className="rounded-3xl border bg-slate-50 p-6">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700">
              <Mini text={`${KEYWORD} clear priorities`} />
              <Mini text={`${KEYWORD} technical fixes list`} />
              <Mini text={`${KEYWORD} content opportunities`} />
              <Mini text={`${KEYWORD} next-step roadmap`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <Section
        ...
        items={[
          "Review indexing, sitemaps, and errors",
          "Analyze content and keyword gaps",
          "Check internal linking structure",
          "Provide a priority action plan",
        ]}
      />
      ...
      <Section
        ...
        items={[
          "Audit checklist and issue list",
          "Priority roadmap (quick wins + long-term)",
          "Content gap summary",
          "Internal link improvement list",
        ]}
      />
      ...
      <Faq
        title={`${KEYWORD} FAQ`}
        items={[
          ["How long does an audit take?", "Usually 3â€“7 days depending on site size."],
          ["Do you fix issues too?", "Yes, we can implement fixes after the audit."],
          ["Do you include content review?", "Yes, content gaps and structure are included."],
          ["Will I get a roadmap?", "Yes, you will get a clear priority list."],
        ]}
      />
    </main>
  );
